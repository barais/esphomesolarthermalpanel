...
namespace esphome
{
  namespace sensordlbus
  {
    ...
    {
    public:
      void set_profile(const std::string &p) { model_ = p; }
      ...
      //  explicit SensorDLBus() : PollingComponent(50000) {} // 30 Seconds
      explicit SensorDLBus(InternalGPIOPin *dl_pin);
